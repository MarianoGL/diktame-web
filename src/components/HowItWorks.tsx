...
const steps = [
  {
    number: '01',
    title: 'Pulsa',
    description: 'Mantén pulsada la tecla Fn en cualquier app. Diktame empieza a escucharte al instante.',
    icon: (
  ...
  },
  {
    number: '02',
    title: 'Habla',
    description: 'Di lo que quieras. Whisper AI procesa tu voz localmente en el Neural Engine de tu Mac.',
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
  ...
  },
  {
    number: '03',
    title: 'Pega',
    description: 'Suelta la tecla. El texto se pega automáticamente donde tengas el cursor. Sin pasos extra.',
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-20 reveal">
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-white">
            Tres pasos.{' '}
            <span className="italic text-neutral-500">Cero fricción.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          {steps.map((step, i) => (
            ...
            >
              {/* Step number */}
              <span className="text-xs font-mono text-amber-warm/40 mb-6 block">
                {step.number}
              </span>
