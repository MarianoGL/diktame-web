  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bars; i++) {
        ...
        // Bell curve envelope - taller in center
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center pt-24 pb-20">
        ...
        >
          Tu voz,{' '}
          <span className="italic text-amber-warm amber-glow-text">
            tu texto.
          </span>
        </h1>
        ...
        >
          Dictado por voz para macOS que funciona sin internet.
          <br className="hidden sm:block" />
          Pulsa, habla, pega. Nada sale de tu Mac.
        </p>
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/5 bg-surface-800/50 backdrop-blur-sm p-6">
            ...
            <div className="mt-4 pt-4 border-t border-white/5">
              <p className="text-sm text-neutral-300 font-mono text-left">
                ...
                Diktame transcribe tu voz a texto en tiempo real, directamente en tu Mac...
              </p>
            </div>
          </div>
